...
app.controller('masterCtrl', ['$http', '$chttp', '$timeout', '$interval', '$q', function ($http, $chttp, $timeout, $interval, $q) {
  ...
  let geo_success = (position)=>{
    ...
    vm.conv.then(()=>{
      ...
      $chttp.get('//script.google.com/macros/s/AKfycbzQ4aytAhVinfiYxMy2G-4whWFXv1V1YIbc1LE8KQPZcQQT6Odi/exec?url='+url_param, 0, {}, vm.canceler.promise, ['//cdn.real-timer.tk:2087/?url='+url_param]).then(function (data) {
        if (!vm.userTapped) {
          vm.success = true;
          vm.data = data;
